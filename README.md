...
2. Download the zip of this repository or download from [PyPI](https://pypi.python.org/pypi/cloudcoverage/2.2) to the directory in which you plan to use it and unzip.
